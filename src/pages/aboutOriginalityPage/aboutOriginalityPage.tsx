    ...
    <main>
      ...
      >
        <p>
          ...
          accumsan rutrum. Quisque eget neque non arcu faucibus consequat ac nec
          est. In sed purus dui. Nullam at ante scelerisque, semper arcu eget,
          pellentesque leo. In viverra aliquam mattis. Proin sodales maximus
          felis, sit amet placerat dolor vulputate id. Praesent ac maximus sem.
          Curabitur nibh metus, posuere et blandit at, tincidunt id dui.
        </p>
      </TextBlockWithImage>
      ...
      <div>
        ...
        <TextBlockWithImage
          ...
          imageAlt="Placdeholder image"
          imagePlacement="left"
          imageSize="small"
        >
          <p>
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Placeat,
            dignissimos itaque in dolor earum similique consectetur rerum
            voluptatem, cupiditate nostrum soluta ea maxime porro accusamus esse
            nesciunt quia? Repellendus repudiandae, quod est nihil quas numquam,
            suscipit rerum pariatur, obcaecati assumenda commodi debitis
      ...
      >
        <p>
          ...
          quasi beatae laudantium, doloremque perferendis et adipisci,
          cupiditate illo voluptate iure dolorum. Pariatur tenetur, mollitia
          recusandae corrupti, impedit quaerat a expedita omnis suscipit laborum
          non neque placeat dolores eius, iure doloremque alias. In rem quam
          corporis ducimus quaerat iure molestias voluptatibus!
        </p>
      </TextBlockWithImage>
