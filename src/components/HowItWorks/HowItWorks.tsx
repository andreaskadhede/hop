    ...
    <div className={classNames(styles.howItWorks)}>
      <section className={classNames(styles.textArea)}>
        ...
        <div className={classNames(styles.text)}>
          ...
          <p>
            The system is role-based. Different roles carry out different tasks
            at various points during the set up/running of a flow (assessment
            process).  
          </p>
          <p>
            Flows can be configured and combined to support the desired
            assessment type. The flow type determines what answers can be
            submitted and the security level. What’s more, several of the flow
            types are specially designed for supporting group assessments.  
          </p>
        </div>
      </section>
      ...
      <section className={classNames(styles.textArea)}>
        ...
        <div className={classNames(styles.text)}>
          <p>
            ...
            laborum odio dicta officiis provident porro autem. Harum similique,
            odio, animi reiciendis omnis amet nemo fuga dignissimos consequuntur
            placeat distinctio temporibus.
          </p>
          <p>
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Cumque
            distinctio dolorum dicta quidem aperiam eveniet sequi quas rerum,
            aliquam labore deserunt minima, doloribus quibusdam nobis eos,
            deleniti est consectetur odit?
          </p>
          <p>
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Obcaecati,
            amet quam nobis, quaerat vero officia saepe tempore nostrum nesciunt
            illo at explicabo cum, hic sit laborum eos sunt. Suscipit,
            exercitationem.
          </p>
        </div>
      </section>
