         ...
         <div className={classNames(styles.left)}>
            <div className={classNames(styles.text)}>
               ...
               <p>
                  ...
                  massa turpis. Suspendisse potenti. Praesent hendrerit neque
                  sit amet nulla accumsan rutrum. Quisque eget neque non arcu
                  faucibus consequat ac nec est. In sed purus dui. Nullam at
                  ante scelerisque, semper arcu eget, pellentesque leo. In
                  viverra aliquam mattis. Proin sodales maximus felis, sit amet
                  placerat dolor vulputate id. Praesent ac maximus sem.
