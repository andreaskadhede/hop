  ...
  return (
    <div className={classNames(styles.contactForm)}>
      <section className={classNames(styles.textArea)}>
        ...
        <p>
          Learn how innovators at institutions across Europe have successfully
          made their cases.
        </p>
      </section>
      ...
      <div className={classNames(styles.checkboxArea)}>
        <p>
          UNIwise ApS is committed to protecting and respecting your privacy,
          ...
          us. From time to time, we would like to contact you about our products
        ...
        <p>
          ...
          our Privacy Policy. By clicking submit below, you consent to allow
          UNIwise ApS to store and process the personal information submitted
