      ...
      <div className={classNames(styles.container)}>
        ...
        <div className={classNames(styles.hub)}>
          ...
          <p>
            ...
            and explore why effective change management is so important to the
        ...
        <div className={classNames(styles.hub)}>
          ...
          <p>
            ...
            online learning approach, and digital assessment platforms can
        ...
        <div className={classNames(styles.hub)}>
          ...
          <p>
            ...
            promote and ensure data privacy to guarantee the protection of staff
            and students alike…
          </p>
          <Button content="Learn more" />
        </div>
        <div className={classNames(styles.hub)}>
          ...
          <p>
            ...
            best practices that we’ve seen used by institutions we support,
