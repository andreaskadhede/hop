      ...
      <div className={classNames(styles.WISEcon25)}>
         ...
         <div className={classNames(styles.right)}>
            <div className={classNames(styles.text)}>
               ...
               <p>
                  WISEcon25, a two-day event hosted and curated by UNIwise,
                  brings together people who are passionate about learning
                  technology across all levels of higher education, from the
                  Exams Office to the Pro Vice Chancellor’s office, to share
                  their knowledge and experience.
               </p>
               <div className={classNames(styles.info)}>
                  <p>
                     WISEcon speaker ticket price: €275 WISEcon regular ticket
                     price: €469
                  </p>
